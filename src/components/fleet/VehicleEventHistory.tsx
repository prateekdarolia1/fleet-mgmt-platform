/**
 * VehicleEventHistory Component
 * DDD: Vehicle Event Sourcing - Event History Display
 * SOLID: Single Responsibility - Display vehicle event timeline
...
interface VehicleEventHistoryProps {
  events: VehicleEvent[];
  isLoading: boolean;
}
...
export const VehicleEventHistory = ({
  events,
  isLoading
}: VehicleEventHistoryProps) => {
  if (isLoading) {
    return (
      <Card className="border-gray-200">
        <CardHeader className="pb-3">
          ...
          <p className="text-sm text-gray-500 mt-1">
            Complete append-only timeline of all vehicle events
          </p>
        </CardHeader>
        <CardContent>
        ...
        {events.length === 0 ? (
          <div className="text-center py-8 text-gray-500">
            ...
            <p className="text-sm mt-1">
              Vehicle events will appear here as they occur
            </p>
          </div>
        ) : (
                ...
                <div className="ml-7 space-y-1 text-sm">
                  {event.battery_id && (
                    <p className="text-gray-700">
                      ...
                      <span className="font-mono font-semibold">{event.battery_id}</span>
                    </p>
                  )}
                  ...
                  {event.rider_id && (
                    <p className="text-gray-700">
                      ...
                      <span className="font-mono font-semibold">{event.rider_id}</span>
                    </p>
                  )}
