-- ============================================================================
-- Migration: Add p_rental_amount to confirm_rental_start
-- Date: 2026-04-04
--
-- Fixes:
-- 1. confirm_rental_start had no p_rental_amount param, so rental_ledgers.rental_amount
--    was never set (remained 0 from create_rental_ledger), and all rental_payments
--    were generated with amount_due=0.
-- 2. Added v_effective_amount which uses p_rental_amount when provided,
--    falling back to whatever the ledger already had.
-- ============================================================================
...
BEGIN
  ...
  --    Use p_rental_amount if caller provided it (>0), else keep existing
  -- ------------------------------------------------------------------
  ...
  -- ------------------------------------------------------------------
  -- 5. Generate full payment schedule
